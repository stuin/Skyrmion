...
const static skColor COLOR_RED = skColor(1.0f,0.0f,0.0f,1.0f);
const static skColor COLOR_GREEN = skColor(0.0f,1.0f,0.0f,1.0f);
const static skColor COLOR_BLUE = skColor(0.0f,0.0f,1.0f,1.0f);
